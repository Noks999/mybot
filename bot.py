...
• Hide Menu""",
    ...
    # В PRODUCTS добавить после 'external':
    'silent': {
        'name': ' SILENT PANEL',
        'emoji': '🔇',
        'desc': """🔇 <b>SILENT PANEL</b>
• Silent Aim 
• Aimbot Rage
• No Recoil
• Ignore Knocked 
...
• Полностью скрытный чит
• Невидим для античита
• Silent Aim (тихий аим)
• Silent ESP (скрытый ESP)
• No Recoil (без отдачи)
• Stream Proof (не видно на стриме)
• Максимальная защита от бана""",
    'prices': {1: 150, 7: 300, 30: 500}
    },

    'premium': {
        'name': ' PREMIUM PANEL',
        'emoji': '📡',
        'desc': """📡 <b>PREMIUM PANEL</b>
...
def shop_menu():
    ...
    builder.button(text="🔇 SILENT PANEL", callback_data="b_silent")
    builder.button(text="🎯 AIMBOT PANEL", callback_data="b_aimbot")
    builder.button(text="👁 ESP PANEL", callback_data="b_esp")
    builder.button(text="📡 PREMIUM PANEL", callback_data="b_premium")
...
def admin_menu():
    ...
    builder.button(text="➕ KEYAUTH SILENT", callback_data="akp_silent")
    builder.button(text="➕ KEYAUTH AIM", callback_data="akp_aimbot")
    builder.button(text="➕ KEYAUTH ESP", callback_data="akp_esp")
    builder.button(text="➕ KEYAUTH PREMIUM", callback_data="akp_premium")
...
async def start(message: types.Message):
    ...
    await message.answer("""⚡️ <b>EXPLOIT XITERS</b> ⚡️
...
🔷 <b>INTERNAL</b> — полный контроль
🔇 <b>SILENT</b> — скрытный режим
🎯 <b>AIMBOT + BH</b> — идеальная точность
🤖 <b>DRIP ANDROID</b> — для телефона
🍏 <b>FLUORITE IOS</b> — для iPhone
...
async def callbacks(call: types.CallbackQuery, state: FSMContext):
    ...
    # ============ АДМИН-ПАНЕЛЬ ============
        ...
        builder.button(text="👁 ESP", callback_data="spp_esp")
        builder.button(text="👁 PREMIUM", callback_data="spp_premium")
        builder.button(text="🤖 DRIP", callback_data="spp_drip")
        builder.button(text="🍏 FLUORITE", callback_data="spp_fluorite")
        builder.button(text="🔇 SILENT", callback_data="spp_silent")
        builder.button(text="🔙 НАЗАД", callback_data="admin_panel")
